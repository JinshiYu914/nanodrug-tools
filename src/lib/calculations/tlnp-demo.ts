  ...
  data.purification.chromatograms = [
    {
      ...
      points: [
        { x: 0, xValues: { mL: 0 }, y: [0.02, 0.01] },
        { x: 2, xValues: { mL: 2 }, y: [0.08, 0.06] },
        { x: 4, xValues: { mL: 4 }, y: [0.46, 0.38] },
        { x: 6, xValues: { mL: 6 }, y: [0.92, 0.78] },
        { x: 8, xValues: { mL: 8 }, y: [0.41, 0.32] },
        { x: 10, xValues: { mL: 10 }, y: [0.12, 0.08] },
        { x: 14, xValues: { mL: 14 }, y: [0.36, 0.05] },
        { x: 18, xValues: { mL: 18 }, y: [0.04, 0.02] },
      ],
